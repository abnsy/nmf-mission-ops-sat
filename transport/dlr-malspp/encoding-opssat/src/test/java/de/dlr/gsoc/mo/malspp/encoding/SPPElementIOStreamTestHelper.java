...
public abstract class SPPElementIOStreamTestHelper {
  ...
  protected static Long[] ATTRIBUTES =
      new Long[] {
  ...
  protected static enum TestContext {
    PUBSUB_PUBLISH_UPDATE,
    PUBSUB_NOTIFY_UPDATE,
    PUBSUB,
    ERROR_NUMBER,
  ...
  protected static final Map<String, Object> fixedQosProperties = new HashMap<>();
  ...
  protected abstract void performTest(
      ...
      TestActualType actualType,
      TestDeclaredType declaredType,
      byte[] buffer)
      throws Exception;

  protected static TestData constructTest(
      TestContext testContext, TestActualType actualType, TestDeclaredType declaredType) {
    ...
    switch (actualType) {
      case NULL:
        ...
        allowedShortForms =
            new Long[] {
              IdentifierList.SHORT_FORM, Attribute.SHORT_SHORT_FORM, Attribute.ULONG_SHORT_FORM
            };
        value = null;
        break;
      case JAVA_ATTRIBUTE:
        ...
        allowedShortForms =
            new Long[] {
              Attribute.INTEGER_SHORT_FORM, Attribute.URI_SHORT_FORM, EntityRequest.SHORT_FORM
            };
        break;
      case MAL_ATTRIBUTE:
        ...
        allowedShortForms =
            new Long[] {Attribute.INTEGER_SHORT_FORM, Attribute.UOCTET_SHORT_FORM, File.SHORT_FORM};
        break;
      case MAL_ELEMENT:
        shortForms.add(IdBooleanPair.SHORT_FORM);
        value = new IdBooleanPair(new Identifier("DLR"), Boolean.TRUE);
        allowedShortForms =
            new Long[] {IdBooleanPair.SHORT_FORM, Pair.SHORT_FORM, NamedValue.SHORT_FORM};
        break;
    ...
    switch (testContext) {
      case PUBSUB_PUBLISH_UPDATE:
        ...
        ctx =
            prepareMockCtx(
                ...
                MALPubSubOperation._PUBLISH_STAGE,
                1,
                shortForms.toArray(new Long[] {}),
                allowedShortForms,
                false);
        break;
      case PUBSUB_NOTIFY_UPDATE:
        ...
        ctx =
            prepareMockCtx(
                InteractionType.PUBSUB,
                MALPubSubOperation._NOTIFY_STAGE,
                2,
                shortForms.toArray(new Long[] {}),
                allowedShortForms,
                false);
      ...
      case ERROR_NUMBER:
        ...
        ctx =
            prepareMockCtx(
                ...
                MALSubmitOperation._SUBMIT_ACK_STAGE,
                0,
                shortForms.toArray(new Long[] {}),
                allowedShortForms,
                true);
  ...
  protected static MALEncodingContext prepareMockCtx(
      InteractionType interactionType,
      int stage,
      int bodyElementIndex,
      Long[] shortForms,
      Long[] allowedAbstractShortForms,
      boolean isError) {
    ...
    when(ctx.getOperation().getOperationStage(st).getLastElementShortForms())
        .thenReturn(allowedAbstractShortForms);
  ...
  public void testElementPubSubNotify1() throws Exception {
    performTest(
        TestContext.PUBSUB_NOTIFY_UPDATE,
        TestActualType.UPDATE_LIST,
        TestDeclaredType.CONCRETE,
        new byte[] {3, 1, 2, (byte) 0xAB, (byte) 0xCD, 0, 1, 1, (byte) 0xEF});
  }
  ...
  public void testElementPubSub() throws Exception {
    performTest(
        TestContext.PUBSUB,
        TestActualType.IDENTIFIER_LIST,
        TestDeclaredType.CONCRETE,
        new byte[] {2, 1, 1, 0x61, 1, 1, 0x42});
  }

  @Test
  public void testElementStandard1() throws Exception {
    performTest(
        TestContext.STANDARD,
        TestActualType.JAVA_ATTRIBUTE,
        TestDeclaredType.CONCRETE,
        new byte[] {1, 83});
  }
  ...
  public void testElementStandard2() throws Exception {
    performTest(
        TestContext.STANDARD,
        TestActualType.JAVA_ATTRIBUTE,
        TestDeclaredType.ABSTRACT_ATTRIBUTE,
        new byte[] {1, 10, 83});
  }
  ...
  public void testElementStandard3() throws Exception {
    performTest(
        TestContext.STANDARD,
        TestActualType.JAVA_ATTRIBUTE,
        TestDeclaredType.ABSTRACT_ELEMENT,
        new byte[] {1, 0, 1, 0, 0, 1, 0, 0, 11, 83});
  }
  ...
  public void testElementStandard6() throws Exception {
    performTest(
        ...
        TestActualType.MAL_ATTRIBUTE,
        TestDeclaredType.ABSTRACT_ELEMENT,
        new byte[] {1, 0, 1, 0, 0, 1, 0, 0, 8, (byte) 210});
  }
  ...
  public void testElementStandard7() throws Exception {
    performTest(
        TestContext.STANDARD,
        TestActualType.MAL_ELEMENT,
        TestDeclaredType.CONCRETE,
        new byte[] {1, 1, 3, 0x44, 0x4C, 0x52, 1, 1});
  }
  ...
  public void testElementStandard8() throws Exception {
    performTest(
        ...
        TestActualType.MAL_ELEMENT,
        TestDeclaredType.ABSTRACT_ELEMENT,
        new byte[] {1, 0, 1, 0, 0, 1, 0, 0, 27, 1, 3, 0x44, 0x4C, 0x52, 1, 1});
  }

  @Test
  public void testElementStandard9() throws Exception {
    performTest(
        TestContext.STANDARD, TestActualType.NULL, TestDeclaredType.CONCRETE, new byte[] {0});
  }
  ...
  public void testElementError1() throws Exception {
    performTest(
        TestContext.ERROR_NUMBER,
        TestActualType.ERROR_NUMBER,
        TestDeclaredType.CONCRETE,
        new byte[] {(byte) 0x80, (byte) 0x80, 0x04});
  }

  @Test
  public void testElementError2() throws Exception {
    performTest(
        TestContext.ERROR_EXTRA_INFORMATION,
        TestActualType.JAVA_ATTRIBUTE,
        TestDeclaredType.ABSTRACT_ELEMENT,
        new byte[] {1, 0, 1, 0, 0, 1, 0, 0, 11, 83});
  }
  ...
  public void testElementNullContext3() throws Exception {
    performTest(
        ...
        TestActualType.MAL_ELEMENT,
        TestDeclaredType.CONCRETE,
        new byte[] {1, 3, 0x44, 0x4C, 0x52, 1, 1});
  }

  @Test(expected = IllegalArgumentException.class)
  public void testElementNullContext4() throws Exception {
    performTest(TestContext.NULL, TestActualType.NULL, TestDeclaredType.CONCRETE, new byte[] {0});
  }
}
