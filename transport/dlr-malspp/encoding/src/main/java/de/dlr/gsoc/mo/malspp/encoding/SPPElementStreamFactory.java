...
public class SPPElementStreamFactory extends MALElementStreamFactory {
  ...
  @Override
  public MALElementInputStream createInputStream(final InputStream is)
      throws IllegalArgumentException, MALException {
    if (is == null) {
      throw new IllegalArgumentException(ILLEGAL_NULL_ARGUMENT);
    }
  ...
  @Override
  public MALElementOutputStream createOutputStream(final OutputStream os)
      throws IllegalArgumentException, MALException {
  ...
  // elements.
  @Override
  public Blob encode(final Object[] elements, final MALEncodingContext ctx)
      throws IllegalArgumentException, MALException {
    ...
    for (int i = 0; i < elements.length; i++) {
      ...
      try {
        ...
        Logger.getLogger(SPPElementStreamFactory.class.getName())
            .log(
                Level.SEVERE,
                "The Element is type: "
