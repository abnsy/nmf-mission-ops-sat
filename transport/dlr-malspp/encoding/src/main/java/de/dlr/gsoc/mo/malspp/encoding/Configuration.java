...
public class Configuration {
  ...
  protected static final String JAVA_EPOCH =
      "1970-01-01T00:00:00.000"; // needed due to bug in Orekit
   ...
   * @return Multiplier which denotes the number of time units that make up a second. Defaults to 1.
   */
