...
public class SPPElementOutputStreamTest extends SPPElementIOStreamTestHelper {
  ...
  protected void performTest(
      ...
      byte[] buffer)
      throws Exception {
    // System.out.println("OS testing: " + testContext.toString() + ", actual " +
  ...
  public void testWriteElementPubSubNotify1() throws Exception {
    performTest(
        ...
        TestActualType.MAL_ENCODED_ELEMENT,
        TestDeclaredType.CONCRETE,
  ...
  public void testWriteElementPubSub1() throws Exception {
    try {
      performTest(
          TestContext.PUBSUB, TestActualType.NULL, TestDeclaredType.CONCRETE, new byte[] {1});
