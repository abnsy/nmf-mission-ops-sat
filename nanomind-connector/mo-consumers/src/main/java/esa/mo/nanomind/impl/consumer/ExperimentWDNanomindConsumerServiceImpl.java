...
public class ExperimentWDNanomindConsumerServiceImpl extends ConsumerServiceImpl {
  ...
  public ExperimentWDNanomindConsumerServiceImpl(final SingleConnectionDetails connectionDetails)
    ...
    if (MALContextFactory.lookupArea(
            OPSSAT_PFHelper.OPSSAT_PF_AREA_NAME, OPSSAT_PFHelper.OPSSAT_PF_AREA_VERSION)
        == null) {
    ...
    if (tmConsumer != null) {
      try {
        ...
        Logger.getLogger(ExperimentWDNanomindConsumerServiceImpl.class.getName())
