...
public class PowerNanomindConsumerServiceImpl extends ConsumerServiceImpl {
  ...
  public PowerNanomindConsumerServiceImpl(final SingleConnectionDetails connectionDetails)
    ...
    if (tmConsumer != null) {
      try {
        ...
        Logger.getLogger(PowerNanomindConsumerServiceImpl.class.getName())
