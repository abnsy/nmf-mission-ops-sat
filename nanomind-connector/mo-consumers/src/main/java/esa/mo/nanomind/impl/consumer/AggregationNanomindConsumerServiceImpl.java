...
public class AggregationNanomindConsumerServiceImpl extends ConsumerServiceImpl {
  ...
  public AggregationNanomindConsumerServiceImpl(final SingleConnectionDetails connectionDetails)
    ...
    if (tmConsumer != null) {
      try {
        ...
        Logger.getLogger(AggregationNanomindConsumerServiceImpl.class.getName())
